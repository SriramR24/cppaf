...
dataset = pd.read_csv('gas/ML_model/dataset.csv')
...
def analysis( request ):
    ...
    return render(request, "gas/analysis.html", context=context)
...
def forecast( request ):
    ...
    file = open("gas/ML_model/variables/PREDICTIONS_FUTURE", "rb")
    ...
    return render(request, "gas/forecast.html", context=context)
